...
const Movies = () => {
    ...
    const fetchMovies = async () => {
        ...
        // const { data } = await axios.get(`https://api.themoviedb.org/3/discover/movie?api_key=${process.env.REACT_APP_API_KEY}&language=en-US&sort_by=primary_release_date.desc&primary_release_date.gte=2010-01-01&primary_release_date.lte=2021-01-01&vote_average.gte=7&include_adult=false&include_video=false&page=${page}&with_genres=${genreforURL}`);
